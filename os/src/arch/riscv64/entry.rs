use crate::{config::KERNEL_STACK_SIZE, processor};
pub use crate::board::MAX_PROCESSORS;
const PTES_PER_PAGE: usize = 512;
const VIRT_RAM_OFFSET: usize = 0xffff_ffc0_0000_0000;

#[link_section = ".bss.stack"]
static mut BOOT_STACK: [u8; KERNEL_STACK_SIZE*MAX_PROCESSORS] = [0u8; KERNEL_STACK_SIZE*MAX_PROCESSORS];
