...
impl ConstantsHal for Constant {
    ...
    const KERNEL_ADDR_SPACE: core::ops::Range<usize> = 0x9000_0000_0000_0000..0x9000_0080_0000_0000;

    const USER_ADDR_SPACE: core::ops::Range<usize> = 0x0000_0000_0000_0000..0x0000_0040_0000_0000;

    const PA_WIDTH: usize = 40;
    ...
    const SIGRET_TRAMPOLINE_TOP: usize = 0xffff_ffff_ffff_f000;
    ...
    const KERNEL_VM_TOP: usize = 0xffff_ffff_ffff_e000;
